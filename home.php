...
<?php 
    if(isset($_GET["request"]) && $_GET["request"]=="profile-update" && $_GET["status"]=="success"){
        $dialogue="Your profile update was successful! ";
    }
    else if(isset($_GET["request"]) && $_GET["request"]=="profile-update" && $_GET["status"]=="unsuccess"){
        $dialogue="Your profile update was not at all successful! ";
    }
    else if(isset($_GET["request"]) && $_GET["request"]=="login" && $_GET["status"]=="success"){
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-4">
            <ul class="nav text-center">
                ...
                <li><a href="all-users.php">Search Jobs</a></li>
